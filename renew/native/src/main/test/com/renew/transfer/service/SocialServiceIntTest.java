package com.renew.transfer.service;

import com.renew.transfer.RenewappApp;
import com.renew.transfer.domain.Authority;
import com.renew.transfer.domain.User;
import com.renew.transfer.repository.AuthorityRepository;
import com.renew.transfer.repository.UserRepository;
import com.renew.transfer.security.AuthoritiesConstants;
import com.mycompany.myapp.security.jwt.TokenProvider;
import com.renew.transfer.service.MailService;
...
@SpringBootTest(classes = RenewappApp.class)
@Transactional
public class SocialServiceIntTest {
    ...
    public void setup() {
        ...
        socialService = new SocialService(mockUsersConnectionRepository, authorityRepository,
                passwordEncoder, userRepository, userDetailsService, connectionFactoryLocator, mockMailService, tokenProvider);
    }
