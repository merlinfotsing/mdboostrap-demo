import { Component, ViewChild, Input, ElementRef, Renderer2, OnInit, AfterViewInit, forwardRef, Inject, PLATFORM_ID, AfterContentChecked, HostListener } from '@angular/core';
